...
class SimpleCNN(nn.Module):
	...
	def __init__(self):
		super.__init__()
		self.conv1 = nn.Conv2d(in_channels = 1, out_channels = 20, kernel_size = 3, stride = 1, padding = 'same')
		self.bn1 = nn.BatchNorm2d(20)
		self.maxpool1 = nn.MaxPool2d(kernel_size = 2, stride = 2)
		
		self.conv2 = nn.Conv2d(in_channels = 20, out_channels = 40, kernel_size = 3, stride = 1, padding = 'same')
		self.bn2 = nn.BatchNorm2d(40)
		self.maxpool2 = nn.MaxPool2d(kernel_size = 2, stride = 2)

		self.conv3 = nn.Conv2d(in_channels = 40, out_channels = 80, kernel_size = 3, stride = 1, padding = 'same')
		self.bn3 = nn.BatchNorm2d(80)
		self.maxpool3 = nn.MaxPool2d(kernel_size = 2, stride = 2)

		self.conv4 = nn.Conv2d(in_channels = 80, out_channels = 160, kernel_size = 3, stride = 1, padding = 'same')
		self.bn4 = nn.BatchNorm2d(160)
		self.maxpool4 = nn.MaxPool2d(kernel_size = 2, stride = 2)

		self.conv5 = nn.Conv2d(in_channels = 160, out_channels = 320, kernel_size = 3, stride = 1, padding = 'same')
