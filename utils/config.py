...
class BaseConfig:
	...
	def to_json(self) -> str:
		...
		:return: json string
		'''
		return json.dumps(self.filter_serializable(self.__dict__), indent=4,sort_keys=True)
	...
	def to_json_file(self, filename: str) -> None:
		...
		with open(filename, "w", encoding="utf-8") as f:
			json.dump(self.filter_serializable(self.__dict__), f, indent=4,sort_keys=True)
